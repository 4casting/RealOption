...
page = st.sidebar.radio("Gehe zu:", ["Simulation & Analyse", "Modell-Beschreibung"])
...
if page == "Modell-Beschreibung":
    ...
    st.markdown(r"""
    Das Kundenwachstum wird durch eine erweiterte Form des Bass-Modells berechnet, die speziell für wiederkehrende B2B-Geschäfte angepasst wurde. [cite_start]Im Gegensatz zum klassischen Bass-Modell (nur Erstkauf) berücksichtigt dieses Modell **Churn (Kundenabwanderung)**[cite: 15, 310].
    ...
    * **$C$ (Churn)**: Jährliche Abwanderungsrate des Bestands.
    ...
    st.markdown(r"""
    [cite_start]Der monetäre Wert ($W$) jeder Periode berechnet sich aus dem Umsatz abzüglich der Kannibalisierungseffekte (Kunden, die vom profitableren traditionellen Kanal wechseln) und der Fixkosten[cite: 15, 311].
